...
const Iphone = (props) => {
  ...
  useEffect(() => {
    Object.entries(materials).map((material) => {
      ...
      // NOTE: • These strings are the names of the material of a specific model that
      //         cant/should not change color.
      //       • Only changes the color of the materials except these.
      // Checks if the material's name is not one of these, then proceeds to
      //     change the color.
      if (
        ...
        // Update the new color to the material.
